...
@Autonomous (name = "CraterDirective" , group = "Autonomous")
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (detector.getXPosition() > 100 && detector.getXPosition() < 350) {
                ...
                mecanumDrive.turn(mecanumDrive.LEFT, 10, .3);

                mecanumDrive.side(mecanumDrive.LEFT, 4, .5);

                mecanumDrive.move(mecanumDrive.FORWARDS, 45, .5);

                //dropping the marker code goes here

                mecanumDrive.move(mecanumDrive.BACKWARDS, 59, 1);
                sleep(20000);
                ...
                mecanumDrive.move(mecanumDrive.FORWARDS, 20, .67);
                ...
                mecanumDrive.move(mecanumDrive.FORWARDS, 58, .67);

                mecanumDrive.turn(mecanumDrive.LEFT, 10, .3);

                mecanumDrive.side(mecanumDrive.LEFT, 3, .5);

                mecanumDrive.move(mecanumDrive.FORWARDS, 44, .5);

                //dropping the marker code goes here

                mecanumDrive.move(mecanumDrive.BACKWARDS, 56, 1);
                sleep(20000);
